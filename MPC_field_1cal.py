...
if not os.path.exists(os.path.join('Outputs', colo_output_folder, 'pod_harmonization_data.joblib')):
    ...
    pod_harmonization_data, deployment_log = data_loading_func.onehopcal_load_data(harmon_file_list, deployment_log,
...
if settings['run_field'] == False:
    ...
    if not os.path.exists(os.path.join('Outputs', colo_output_folder, 'pod_field_data.joblib')):
        ...
        # load pod data
        pod_field_data, deployment_log = data_loading_func.onehopcal_load_data(field_file_list, deployment_log,
